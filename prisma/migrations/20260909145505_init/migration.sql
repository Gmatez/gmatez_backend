...
-- CreateEnum
CREATE TYPE "CallStatus" AS ENUM ('INITIATED', 'RINGING', 'ACCEPTED', 'CONNECTING', 'CONNECTED', 'REJECTED', 'TIMEOUT', 'CANCELLED', 'FAILED', 'ENDED');

-- CreateEnum
CREATE TYPE "LedgerEntryType" AS ENUM ('CREDIT', 'DEBIT');

-- CreateEnum
CREATE TYPE "LedgerReason" AS ENUM ('PAYMENT_TOPUP', 'CALL_CHARGE', 'CALL_REFUND', 'ADMIN_ADJUSTMENT', 'PROMOTIONAL_CREDIT');
...
-- CreateEnum
CREATE TYPE "ReportReason" AS ENUM ('HARASSMENT', 'SPAM', 'INAPPROPRIATE_CONTENT', 'FRAUD', 'OTHER');
...
CREATE TABLE "Profile" (
    ...
    "ratePerMinuteCents" INTEGER NOT NULL DEFAULT 100,
...
CREATE TABLE "Wallet" (
    ...
    "heldBalanceCents" INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE "Call" (
    ...
    "endedAt" TIMESTAMP(3),
    "endReason" TEXT,
    "callerHeartbeatAt" TIMESTAMP(3),
    "calleeHeartbeatAt" TIMESTAMP(3),
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE INDEX "Profile_isDiscoverable_lastActiveAt_idx" ON "Profile"("isDiscoverable", "lastActiveAt" DESC);
...
-- CreateIndex
CREATE INDEX "WalletLedgerEntry_walletId_createdAt_id_idx" ON "WalletLedgerEntry"("walletId", "createdAt" DESC, "id" DESC);
...
-- CreateIndex
CREATE UNIQUE INDEX "Call_providerSessionId_key" ON "Call"("providerSessionId");
...
-- CreateIndex
CREATE INDEX "Call_status_updatedAt_idx" ON "Call"("status", "updatedAt");
